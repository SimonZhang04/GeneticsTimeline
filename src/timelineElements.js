let timelineElements = [
    ...
    },
    {
        ...
        description: 'In 1928, British bacteriologist Frederick Griffith discovered the process of “transformation.” He experimented with two strains of the bacterium Streptococcus pneumoniae. One strain, which he named the S-strain (as it had a smooth capsule) caused mice to develop pneumonia and die. The other strain that was harmless to the mice was named the R-strain (for its rough capsule). Griffith heated the S-strain cells, killing the bacteria. When he combined the heat-killed S-strain cells with the R-strain cells, he noticed that the mice injected contracted pneumonia and died. This meant that the R-strain bacteria acquired characteristics from the S-strain that made them deadly. The R-strain bacteria were able to grow smooth colonies. From this experiment, Griffith concluded that bacteria can take genetic material from nearby bacteria and use the DNA as their own. He called this process where a hereditary substance is passed on “transformation."',
        date: "1928",
        icon: 'DNA',
    ...
    },
    {
        ...
        description: 'In 1983, American biochemist Kary Banks Mullis invented the polymerase chain reaction (PCR). This process allowed certain segments of DNA to be replicated billions of times in just a few hours. The method involves four ingredients: a template DNA, two oligonucleotide primers (short segments of single-stranded DNA complementary to the one of the strands of the template DNA), nucleotides, and a polymerase enzyme. When the ingredients are heated, the template DNA splits into 2 strands. The primers bind to the complementary sites and the polymerase begins copying the template strands by adding nucleotides onto the end of the primers. The polymerase chain reaction has many applications such as: screening patients for genetic disorders, studying DNA from fossils, identifying crime suspects, and is now commonly used for COVID-19 tests. In 1993, Mullis was awarded a Nobel Prize in Chemistry.        In 1983, American biochemist Kary Banks Mullis invented the polymerase chain reaction (PCR). This process allowed certain segments of DNA to be replicated billions of times in just a few hours. The method involves four ingredients: a template DNA, two oligonucleotide primers (short segments of single-stranded DNA complementary to one of the strands of the template DNA), nucleotides, and a polymerase enzyme. When the ingredients are heated, the template DNA splits into 2 strands. The primers bind to the complementary sites and the polymerase begins copying the template strands by adding nucleotides onto the end of the primers. The polymerase chain reaction has many applications such as screening patients for genetic disorders, studying DNA from fossils, identifying crime suspects, and is now commonly used for COVID-19 tests. In 1993, Mullis was awarded a Nobel Prize in Chemistry.       ',
        date: "1983",
        icon: 'DNA',
