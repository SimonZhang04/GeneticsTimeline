let timelineElements = [
    ...
    },
    {
        ...
        description: 'In 1983, American biochemist Kary Banks Mullis invented the polymerase chain reaction (PCR). This process allowed certain segments of DNA to be replicated billions of times in just a few hours. The method involves four ingredients: a template DNA, two oligonucleotide primers (short segments of single-stranded DNA complementary to one of the strands of the template DNA), nucleotides, and a polymerase enzyme. When the ingredients are heated, the template DNA splits into 2 strands. The primers bind to the complementary sites and the polymerase begins copying the template strands by adding nucleotides onto the end of the primers. The polymerase chain reaction has many applications such as screening patients for genetic disorders, studying DNA from fossils, identifying crime suspects, and is now commonly used for COVID-19 tests. In 1993, Mullis was awarded a Nobel Prize in Chemistry.         ',
        date: "1983",
        icon: 'DNA',
